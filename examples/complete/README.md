...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_agfw"></a> [agfw](#module\_agfw) | ../../ | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_agw_id"></a> [agw\_id](#output\_agw\_id) | Resource id of the application gateway. |
| <a name="output_backend_pool_ids_zipmap"></a> [backend\_pool\_ids\_zipmap](#output\_backend\_pool\_ids\_zipmap) | Backend pool name to { name, id }. |
...
| <a name="output_private_frontend_ip_address"></a> [private\_frontend\_ip\_address](#output\_private\_frontend\_ip\_address) | Static private frontend ip. |
| <a name="output_waf_policy_id"></a> [waf\_policy\_id](#output\_waf\_policy\_id) | Resource id of the WAF policy. |
<!-- END_TF_DOCS -->
